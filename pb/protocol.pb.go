...
func (m *PubMsg) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Topic) > 0 {
		dAtA[i] = 0x5a
		i++
		i = encodeVarintProtocol(dAtA, i, uint64(len(m.Topic)))
...
var fileDescriptorProtocol = []byte{
	...
	,
}
